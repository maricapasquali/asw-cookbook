...
export interface IChat extends Document {
    ...
    users: { user: IUser["_id"], role: IChat.Role, enteredAt: number, exitedAt?: number }[]
    messages: IMessage[]
}
export namespace IChat {
    ...
    export namespace Type {
        export function values(): IChat.Type[] {
    ...
    export namespace Role {
        export function values(): IChat.Role[] {
