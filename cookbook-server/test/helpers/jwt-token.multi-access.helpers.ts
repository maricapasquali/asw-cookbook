...
// - actions
export const loginInDevice1 = (tokenManager: IJwtTokensManager, token1_dev1: Tokens, token2_dev1: Tokens) => {
...
export const loginInDevice2 = (tokenManager: IJwtTokensManager, token1_dev2: Tokens, token2_dev2: Tokens) => {
...
export const logoutInDevice1 = (tokenManager: IJwtTokensManager, token1_dev1: Tokens, token2_dev1: Tokens) => {
...
export const logoutInDevice2 = (tokenManager: IJwtTokensManager, token1_dev2: Tokens, token2_dev2: Tokens) => {
...
export const updateAccessTokenInDevice1 = (tokenManager: IJwtTokensManager, token1_dev1: Tokens, token2_dev1: Tokens): any => {
...
export const printTokensList = (tokenManager: IJwtTokensManager, message?: string) => {
...
// - checks
export const checkLengthTokensList = (tokenManager: IJwtTokensManager, expected: number) => {
...
export const checkContent = (tokenManager: IJwtTokensManager, checker: string, expected1: Tokens[], expected2: Tokens[]) => {
...
export const checkTokenValidity = (tokenManager: IJwtTokensManager, tokens: Tokens[], typeToken, expected: boolean | any) => {
