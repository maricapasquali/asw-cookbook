              ...
              >
                <b-input-group>
                  <custom-select
                    ...
                    placeholder="Seleziona un opzione di ricerca"
      ...
      <b-col class="px-0">
        ...
        >
          ...
          <template #cell(_id)="row">
            <b-alert
              class="col mb-0 notification"
              :variant="notificationColor(row.item.type)"
              show
            >
              <b-container>
                <b-row>
                  ...
                  >
                    <b-button-close
                      title="Rimuovi"
                      @click="deleteNotification(row.index)"
                    />
                  </b-col>
                </b-row>
                <b-row>
            ...
            switch (doc.type) {
                ...
                case "recipe":
                    ...
                    if (doc.otherInfo.recipe.shared || !doc.otherInfo.updaterUser) return {
                        name: "single-recipe",
                        params: { id: doc.otherInfo.recipe.owner, recipeId: doc.otherInfo.recipe._id },
                ...
                case "comment":
                    return {
                        name: "single-recipe",
                        params: { id: doc.otherInfo.recipe.owner._id, recipeId: doc.otherInfo.recipe._id },
                ...
                case "report":
                    ...
                    return { name: "single-recipe", params: { id: doc.otherInfo.recipe.owner, recipeId: doc.otherInfo.recipe._id }, hash: "#comment-"+doc.otherInfo.comment._id }
