        ...
        >
          ...
          >
            ...
            >
              <b-card
                no-body
                class="container-find-user"
              >
                <b-container class="p-4">
                  <b-row
                    cols="1"
                    cols-sm="2"
                    class="body-find-user h-100"
                  >
                    <b-col
                      cols="12"
                      sm="4"
                    ...
                    >
                      <b-container fluid>
                        <b-row cols="1">
                          <b-col>
                            <router-link :to="{name: 'single-user', params: {id: user._id}}">
                              <strong><em>{{ user.userID }}</em></strong>
                            </router-link>
                          </b-col>
                  ...
                  <b-row
                    cols="1"
                    class="text-right footer-find-user"
                  >
                    <country-image
                      v-if="user.information.country"
                      :id="user._id"
            ...
            <b-col
              v-if="search.mode && !atLeastOneUser"
              class="mt-4"
            >
          ...
          >
            <load-others
              ...
              :in-processing="processingOthers"
              @load="others"
            >
